...
public class Pareja {
	...
	public Pareja(String nombre, int edad, String carrera, LocalDateTime aniversario) { //NUNCA EL ID EN EL CONSTRUCTOR
		this.nombre = nombre;
		this.edad = edad;
	...
	public String toString() {
		return "Pareja [id=" + id + ", nombre=" + nombre + ", edad=" + edad + ", carrera=" + carrera + ", aniversario="
				+ aniversario + "]";
	}
